...
// .test.ts for the rationale. Existing send-for-qa / qa-fix-and-retest tests
// must keep passing unchanged; new 412 refusal tests live in
// fleet-action-preconditions.test.ts.
